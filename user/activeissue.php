        ...
        <div class="features-boxed" style="background: #ffffff;">
            <div class="container" style="background: #ffffff;">
                <div class="intro" style="background: #1A4E85;margin-top: 120px;margin-bottom: 30px;">
                    <h2 class="text-center" data-aos="fade" style="color: rgb(255,255,255);padding: 30px;margin-bottom: 0px;">Your Active Issues</h2>
                </div>
            </div>
        </div>
...
$database = "voiceup";
	...
	$con = mysqli_connect($servername, $username, $password,$database);
        $count = $con->query("SELECT * from issue i,user u  where u.u_id=i.i_u_id and u_mobile=$u_mobile and i.i_status=0")->num_rows;
        if($count==0){ ?>
        ...
        $q = "SELECT * from issue i,user u  where u.u_id=i.i_u_id and u_mobile=$u_mobile and i.i_status=0";
            ...
            ?>
                <div class="post">
                    ...
                    <div class="post-content">
                        <p class="post-date">Posted on <?php echo $res['i_date'];  ?></time> by <?php echo $res['u_name'];  ?> - <strong><?php echo $res['i_privacy'];  ?></strong></p>
