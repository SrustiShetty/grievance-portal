...
$database = "voiceup";
	...
	$con = mysqli_connect($servername, $username, $password,$database);
        ...
        $query = " select * from user where u_mobile=" . $res . "";
        ...
        <div class="features-boxed">
            <div class="container" style="background: #ffffff;">
                <div class="intro" style="background: #1A4E85;margin-top: 120px;margin-bottom: 30px;">
                    <h2 class="text-center" data-aos="fade" style="color: rgb(255,255,255);padding: 30px;margin-bottom: 0px;">User Profile</h2>
                </div>
            </div>
        </div>
