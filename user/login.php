...
if (isset($_SESSION['login_user'])) {
    header("location: submitissue.php"); // Redirecting To Profile Page
}
error_reporting(0);
?>
    ...
    <div class="features-boxed">
        <div class="container-fluid" style="background: #ffffff;">
            <div class="intro" style="background: #1A4E85;margin-top: 120px;margin-bottom: 30px;">
                <h2 class="text-center" data-aos="fade" style="color: rgb(255,255,255);padding: 30px;margin-bottom: 0px;">User Login</h2>
            </div>
        </div>
    </div>
    <div class="login-clean" style="padding: 0px;background: rgb(255,255,255);margin-top: 30px;">
        <form method="post" style="background: #1A4E85;margin-bottom: 40px;">

        <div class="badge alert-danger w-100 p-2 mb-4"><?php echo $error; ?></div>

            <div class="form-group"><input class="form-control" type="phone" name="u_mobile" placeholder="Mobile Number" required></div>
            <div class="form-group"><input class="form-control" type="password" name="u_password" placeholder="Password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required></div>
            <input name="submit" type="submit" class="btn btn-primary btn-block" type="submit" value=" Login "><a class="forgot" href="signup.php" style="color: rgb(255,255,255);margin-top: 15px;">Don't have account? Click here.</a>

        </form>
    </div>
    <div class="footer-dark" style="background: #1A4E85; margin-top: 120px;">
        <footer>
            <div class="container">
