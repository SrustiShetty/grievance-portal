...
$database = "voiceup";
	...
	$con = mysqli_connect($servername, $username, $password,$database);
        ...
        $q = "select * from issue i,user u where u.u_mobile=".$u_mobile." and u.u_id=i.i_u_id and i.i_status=1";
        ...
        ?>
            <div class="post">
                ...
                <div class="post-content">
                    ...
                    <h5 style="display:inline; margin-left:40px; padding:10px; background-color:green;color:white;">Solved</h5>
                </div>
                </div>
        <?php
        }
