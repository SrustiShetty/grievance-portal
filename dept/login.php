...
if (isset($_SESSION['login_dept'])) {
    header("location: personalfeed.php"); // Redirecting To Profile Page
}
error_reporting(0);
?>
...
<head>
    ...
    <title>Government Agencies Login</title>
...
<body id="page-top">
    ...
    <div class="features-boxed">
        <div class="container-fluid" style="background: #ffffff;">
            <div class="intro" style="background: #1A4E85;margin-top: 120px;margin-bottom: 30px;">
                <h2 class="text-center" data-aos="fade" style="color: rgb(255,255,255);padding: 30px;margin-bottom: 0px;">Service Provider Login</h2>
            </div>
        </div>
    </div>
    ...
    <div class="footer-dark" style="background: #1A4E85; margin-top: 80px;">
        <footer>
            <div class="container">
