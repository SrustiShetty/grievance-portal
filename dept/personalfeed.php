        ...
        <div class="features-boxed " style="background: #ffffff;>
            <div class="container" style="background: #ffffff;">
                <div class="intro" style="background: #1A4E85;margin-top: 120px;margin-bottom: 30px;">
                    <h2 class="text-center" data-aos="fade" style="color: rgb(255,255,255);padding: 30px;margin-bottom: 0px;">Issues</h2>
                </div>
            </div>
        </div>
...
$database = "voiceup";
	...
	$con = mysqli_connect($servername, $username, $password,$database);
        $count = $con->query("SELECT * from issue i, user u where i.i_d_id='$d_type' and i.i_u_id=u.u_id and i.i_status=0 ")->num_rows;
        if($count==0){ ?>
        ...
        <?php
        $q = "SELECT  * from issue i, user u where i.i_d_id='$d_type' and i.i_u_id=u.u_id  and i.i_status=0 ";
        ...
        ?>
            <div class="post">
                ...
                <div class="post-content">
                    ...
                    <li class="post-link" style="background:#059618; margin-top:10px;"><a href="markedsolved.php?i_id=<?php echo $res['i_id'];  ?>">
					<button class="btn btn-light " onclick="myFunction()" data-bs-hover-animate="pulse" type="button" style="margin: -5px;background: #059618;color: #fff;margin-left: -5px;border-radius: 5px;">Solve Issue</button></a></li>
                </div>
                </div>
				<script>
function myFunction() {
  alert("This Issue will be solved within 2 days..");
}
</script>
        <?php
        }
