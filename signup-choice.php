...
<head>
    ...
    <title>GRIEVANCE PORTAL SIGNUP </title>
...
<body id="page-top">
    ...
    <div class="article-list" style="background: rgb(252,252,252);">
        <div class="container">
            <div class="intro">
                <div style="background: #1A4E85;margin-top: 20px;margin-bottom: -10px;">
            ...
            <div class="row articles" style="margin: 5px;">
                <div class="col-sm-6 col-md-6 item" style="background: #1A4E85;height: auto;min-height: auto;max-height: auto;font-size: 20px;"><a href="user/signup.php"><img class="img-fluid" data-bs-hover-animate="pulse" src="assets/img/citizens.png" style="text-align: center;filter: invert(100%);">
                        <h3 class="name" style="color: rgb(255,255,255);font-size: 24px; margin-bottom: 40px;">USER</h3>
                    </a>
                </div>
                <div class="col-sm-6 col-md-6 item" style="background: #396fa8;min-height: auto;max-height: auto;"><a href="dept/signup.php"><img class="img-fluid" data-bs-hover-animate="pulse" src="assets/img/government.png" style="filter: invert(100%);">
                        <h3 class="name" style="font-size: 24px;color: rgb(255,255,255); margin-bottom: 40px;">SERVICE PROVIDER </h3>
                    </a>
                </div>
            </div>
        </div>
    </div>
    <div class="footer-dark" style="background: #1A4E85; margin-top:30px">
        <footer>
            <div class="container-fluid">
